...
function autocomplete(input, latInput, lngInput) {
    ...
    var dropdawn = new google.maps.places.Autocomplete(input);

    dropdawn.addListener('place_changed', function () {
        var place = dropdawn.getPlace();
...
function makeMap(mapDiv) {
    ...
    autocomplete.addListener('place_changed', function () {
        ...
        var lat = place.geometry.location.lat();var lng = place.geometry.location.lng();
...
function typeAhead(search) {
    ...
    //handle key beard inputs

    searchInput.on('keyup', function (e) {
        //if aren't pressing up, down ar enter who cares!
        ...
        var next = void 0;
        //if selected, move down or up again
        if (e.keyCode === 40 && current) {
            ...
            //if pressed up go to last
        } else if (e.keyCode === 38) {
            next = items[items.length - 1];
            //if enter window.location in URL
...
var hearthForms = (0, _bling.$$)('form.heart');
hearthForms.on('submit', _heart2.default);
